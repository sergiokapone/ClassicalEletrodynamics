...
\end{equation*}
а ширину спектра частот можна описати величиною:
...
довжини хвильового пакета та ширини інтервалу хвильових векторів у певному напрямі. Квантовий відповідник ~\eqref{eq:uncertainty_relation} --- співвідношення невизначеностей для
