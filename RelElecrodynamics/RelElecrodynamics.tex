...
тоді
\begin{equation*}
    \boldsymbol{\beta} \Bfield_\perp = (0, -\beta B_z, \beta B_y), \quad
    \boldsymbol{\beta} \Efield_\perp = (0, -\beta E_z, \beta E_y).
\end{equation*}
...
\begin{problem}%
    ...
    \]
    що збігається з формулою~\eqref{eq:Dopler} при $\vect{n}\cdot\vect{v}/c = -\beta\cos\theta_0$. Для просторових компонент:
    \[
...
\begin{align*}
    ...
    &= \frac{4\pi}{c}\int G(x-x')\,\frac{\partial}{\partial x'^{\nu}}j^{\nu}(x')\,d^4\vect{x}'
