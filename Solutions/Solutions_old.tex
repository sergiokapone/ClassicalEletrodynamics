...
джерел та полів за \( t < t_0 \), яка може впливати на стан системи за \( t \geqslantt_0 \), є невідомою. Тому, на відміну від п. 2.2, окрім задання функцій
\( \rho(t, \vect{r}) \), \( \vect{j}(t, \vect{r}) \) за \( t \geqslantt_0 \) необхідно задавати певні початкові умови.
...
\begin{equation*}
    K(t) = \{\vect{r} : |\vect{r} - \vect{r}_0| \leqslant R(t)\}, \quad \text{де} \quad R(t) = c(T - t), \quad t \leqslant T.
\end{equation*}
...
\frac{dU}{dt} = -c R^2 \int d\Omega \, W + \frac{c}{4\pi} \int d\Omega \, [\Delta \Efield \times \Delta \Bfield \cdot \vect{n}] \leqslant 0.
\end{equation}
...
\[
\Delta \delta + k^2 \delta = 0 \quad \text{в області} \quad r \geqslantR > 0.
\]
