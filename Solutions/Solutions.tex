...
також рівнянь
Гельмгольца~\eqref{eq:Dphi_Fourier}, \eqref{eq:DA_Fourier} для їх Фур’є-перетворень. Розв’язки~\eqref{eq:Dphi}, \eqref{eq:DA} можна отримати безпосередньо, використовуючи сферично-симетричний
...
Звідси видно, що співвідношення~\eqref{eq:2.3.1} справедливо при \( t > 0 \), якщо воно має місце при \( t = 0 \).
