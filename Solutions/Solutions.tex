...
З будови системи рівнянь видно, що ми можемо задати електромагнітне поле при \( t = 0 \), яке задовольняє рівнянням~\eqref{eq:2.3.1} та
\eqref{eq:2.3.2}, і розв’язувати потім рівняння~\eqref{eq:2.3.3} та~\eqref{eq:2.3.4} при \( t > 0 \). Однак виникає питання, чи зберігаються при цьому
