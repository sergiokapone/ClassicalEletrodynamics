...
відносно шести компонент полів $\Efield$ та $\Bfield$. Незважаючи на те, що система є
надвизначеною, безпосереднє розв'язання її в загальному випадку є непростою задачею.
...
=======
	\phi (t, \vect{r}) = \frac{1}{\sqrt{2\pi}} \int e^{-i\omega t} \tilde{\varphi} (\omega, \vect{r}) d\omega,
>>>>>>> c9c4c7e6bfb51baf6fef565f48829968071dbc67
\end{equation}
\begin{equation}
...
\begin{multline*}
	\frac{1}{c} \frac{\partial \phi}{\partial t} + \Div\vect{A} = \\
