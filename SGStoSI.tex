...
\pagestyle{plain}
%=========================================================
\chapter{Співвідношення між гаусовою системою (СГС) та системою SI}\label{\currfilebase}
%=========================================================

%% --------------------------------------------------------
\section{Таблиця переходу між гаусовою та SI}
%% --------------------------------------------------------
...
\begin{table}[h!]\centering
	\caption{Перехід між гаусовою та SI}
	\label{tab:CGStoSI}
	\small
	\begin{tblr}{
			colspec={l X[c] X[c]},
...
%% --------------------------------------------------------
\section{Приклад: переписування рівнянь Максвела з гаусової системи (СГС) в SI}
%% --------------------------------------------------------
...
Підставимо в перше рівняння (теорема Гаусса):
\begin{equation*}
