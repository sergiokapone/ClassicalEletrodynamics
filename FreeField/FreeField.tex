...
\end{equation}
%
де параметр \(p\) називають \emph{ступенем поляризації}\index{Ступінь!поляризації}; він приймає значення від 0 (неполяризоване світло) до 1.
...
\end{equation*}
а ширину спектру частот опишемо величиною
...
оцінок~тривалості процесу~\eqref{eq:Delta_t} та ширини спектру частот~\eqref{eq:Delta_omega}. З~цього співвідношення
...
Відкидаючи незалежні від часу ненульові розв’язки (що описують статичні поля, а не електромагнітні хвилі), дістанемо:
...
Оскільки вихідне поле \(\vect{A}(t, \vect{r})\) є дійсним, функції \(\vect{C}_1(\vect{k})\) та \(\vect{C}_2(\vect{k})\) не є незалежними. Маємо:
...
Подамо цей розв’язок у дещо іншій формі, виділивши лоренц-інваріантні величини \(\omega_{\vect{k}} - \vect{k} \cdot \vect{r}\).
...
незалежних функцій (яка відповідає ступеням вільності поля) така ж, як у задачі Коші згідно з п.~\ref{sec:Cauchi}.
...
\end{equation}
що має вигляд гамільтоніану континуальної системи осциляторів з частотою $\omega_{\vect{k}}$. Цю формулу називають \emph{розкладом поля на осцилятори}. Зауважимо, що для кожного $\vect{k}$:
\begin{equation*}
