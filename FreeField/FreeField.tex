...
\end{equation*}
%
називають \emph{ступенем взаємної когерентності}\index{ступеінь взаємної когерентності}. Саме ця величина визначає контрастність смуг в інтерференційній картині від двох пучків світла.
...
полів, що можна аналізувати за допомогою перетворення Фур'є\index{Перетворення Фур'є}, зокрема,
...
Це означає, що, кожна мода поля з хвильовим вектором $\vect{k}$ поводиться як незалежний гармонічний осцилятор з частотою $\omega_{\vect{k}}$. Хоча таке представлення електромагнітного поля в класичній електродинаміці видається не більш ніж зручним математичним описом, але саме цей зв'язок має принципове значення при квантуванні: поле набуває вигляду суми незалежних осциляторів, що дозволяє застосувати стандартну процедуру квантування --- перейти до операторів $\hat{\vect{Q}}_{\vect{k}}$, $\hat{\vect{P}}_{\vect{k}}$ із комутаційними співвідношеннями $[\hat{Q}_{j\vect{k}}, \hat{P}_{j'\vect{k}'}] = i\hbar \delta_{jj'}\delta(\vect{k}-\vect{k}')$. Тобто, задача квантування електромагнітного поля зводиться до квантування нескінченної системи осциляторів, що є фундаментальним підходом у квантовій електродинаміці.%
