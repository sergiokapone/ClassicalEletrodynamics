...
Важливою характеристикою випадкового процесу є кореляційна (автокореляційна) функція\refstepcounter{footnote}\footnote{У деяких підручниках у визначенні
...
\begin{equation*}
p = \xi_1^2 + \xi_2^2 + \xi_3^2, \quad 0 \leqslant \xi_1^2 + \xi_2^2 + \xi_3^2 \leqslant 1
\end{equation*}
...
\caption{Зображення параметрів Стокса на сфері Пуанкаре}
\label{pic:Stoke}
\end{figure}
%---------------------------------------------------------
...
\end{equation}
що має вигляд гамільтоніану континуальної системи осциляторів з частотою $\omega_{\vect{k}}$. Цю формулу називають \textit{розкладом поля на осцилятори}. Зауважимо, що для кожного $\vect{k}$:
\begin{equation*}
