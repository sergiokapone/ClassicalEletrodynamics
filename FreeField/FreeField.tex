...
\begin{multline*}
	\mathcal{E} = \int\limits_{-\infty}^{\infty} \oint\limits_{\Omega} \vect{\Pi} \cdot d\vect{S} dt = \frac{c}{4\pi} \oint\limits_{\Omega} \int\limits_{-\infty}^{\infty}
	\left[ \Efield \times \Bfield \right] \cdot dtd\vect{S} = \\
	= \frac{c}{4\pi} \oint\limits_{\Omega} d\vect{S} \cdot \int\limits_{-\infty}^{\infty} \left[ \tilde{\Efield}(\omega) \times \tilde{\Bfield}^{*}(\omega) \right] d\omega
\end{multline*}
...
\begin{equation}\label{eq:Fourier}
	{\phi}(t) = \frac1{\sqrt{2\pi}} \int\limits_{-\infty}^{+\infty} \tilde\phi(\omega)\, e^{-i\omega t}\, dt.
\end{equation}
...
\begin{equation}\label{eq:Delta_t}
	...
	= \int_{-\infty}^{+\infty} t^2\, |\phi(t)|^2\, dt.
\end{equation}
