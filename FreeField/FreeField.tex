...
В попередніх співвідношеннях комплексні величини \(\tilde{\Efield}\), \(\tilde{\Bfield}\) --- це образи Фур’є відповідних дійсних полів. Доцільно розглядати також
...
співвідношень слід повернутися до дійсних частин розв’язків, які мають фізичний зміст.
...
\begin{equation*}
	...
	\omega_a) \tilde\phi \right) \left( x \frac{d\tilde\phi^{*}}{d\omega} + (\omega - \omega_a) \tilde\phi^{*} \right).7
\end{equation*}
