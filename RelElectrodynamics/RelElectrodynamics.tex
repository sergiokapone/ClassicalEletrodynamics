...
\begin{equation*}
    \Efield_\perp = (0, E_y, E_z), \quad \Bfield_\perp = (0, B_y, B_z), \quad \boldsymbol{\beta} = (\beta, 0, 0),
\end{equation*}
тоді
\begin{equation*}
...
\end{equation*}
Завдяки цьому легко обчислити усі компоненти в $S_1$: $R^{\mu}=0$ в момент події~$A$. Але, оскільки, за побудовою, $R^{\mu}$ це 4-вектор, згідно до властивостей векторів він дорівнює нулю у довільній інерціальній системі. Звідси маємо рівняння в момент події~А:
