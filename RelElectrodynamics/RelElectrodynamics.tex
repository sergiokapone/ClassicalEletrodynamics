...
Частота коливань періодичного процесу, яку реєструє спостерігач на світовій лінії $x_\text{obs}^{\mu}(\tau)$, --- це швидкість зміни фази $\Omega\!\left(x_{\text{obs}}^{\mu}(\tau)\right)$ за власним часом спостерігача:
