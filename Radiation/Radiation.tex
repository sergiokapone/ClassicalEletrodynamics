...
Якщо заряд рухається зі сталою швидкістю \( \vect{v}_q = \text{const} \), обчислення напруженостей полів виходячи з \eqref{eq:compact_potential},
\eqref{eq:vector_potential} дає нульовий потік на нескінченності, оскільки поля спадають, як \( 1/r^2 \). Це найбільш очевидно в системі спокою заряду.
...
Нехтуючи членами більш високого порядку по  $\frac1r$ при обчисленні $\Rot\vect{A}$, з \eqref{eq:dipole_potential}, \eqref{eq:magnetic_dipole_potential},
