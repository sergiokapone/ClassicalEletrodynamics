...
\begin{equation*}
	\omega_H = \frac{v_q}{r_q} = \frac{eB}{\gamma m c}\sqrt{1 - \frac{v_q^2}{c^2}},
\end{equation*}
прискорення:
\begin{equation*}
...
\begin{equation*}
	\left\langle \frac{d\epsilon}{dt} \right\rangle_t = \frac{\omega^4 \vect{d}_0^2}{3c^3}.
\end{equation*}
...
\begin{equation*}
X_{iijj} = 4\pi = \int d\Omega \cdot 1.
\end{equation*}
